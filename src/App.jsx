  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden font-sans text-white bg-slate-950">
      <video
        ...
        playsInline
        loop 
        className="absolute top-0 left-0 w-full h-full object-cover blur-3xl scale-110 opacity-60 z-0"
      >
      ...
      <div className="relative z-10 flex w-full h-full justify-center items-center md:justify-start">

        <div className="w-[90%] sm:w-[420px] md:w-[450px] lg:w-[500px] md:h-full">
          <div className="w-full h-auto md:h-full bg-black/40 md:bg-black/30 backdrop-blur-2xl border border-white/20 md:border-y-0 md:border-l-0 md:border-r md:border-white/10 p-8 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center rounded-3xl md:rounded-none shadow-[0_8px_32px_rgba(0,0,0,0.3)] md:shadow-[20px_0_50px_rgba(0,0,0,0.5)]">
            
            <div className="w-full max-w-sm mx-auto flex flex-col">
              <div className="flex justify-center mb-10">
                <img src="/img.png" alt="Qawayim Logo" className="h-20 w-auto" />
              </div>
